    ...
    <div class="container-fluid">
        ...
        <div class="col-md-5">
            <div class="row mapAndFunction">
                ...
                <div class="col-md-12 comment">Select a region to get the functions</div>
            </div>
        ...
        <div class="col-md-7">
            <div class="row imageFluxDiv">
                ...
                <map id="mapForImageFlux" name="mapForImageFlux">
                    <!--                    <area shape="rect" href="#" alt="FossilFuel" title="Fossil Fuel" coords="344,56,423,90"/>-->
                    ...
                    <area shape="rect" href="#" alt="FF trade" title="Fossil fuel trade" coords="306,388,426,416"/>
